...
newBigtableAdminOperationsCancel name
  = BigtableAdminOperationsCancel{xgafv = Core.Nothing,
                                  accessToken = Core.Nothing, callback = Core.Nothing, name = name,
                                  uploadType = Core.Nothing, uploadProtocol = Core.Nothing}
instance Core.GoogleRequest BigtableAdminOperationsCancel where
        type Rs BigtableAdminOperationsCancel = Empty
        type Scopes BigtableAdminOperationsCancel =
        ...
        requestClient BigtableAdminOperationsCancel{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy BigtableAdminOperationsCancelResource)
                      Core.mempty
