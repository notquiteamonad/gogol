...
-- |
-- Module      : Gogol.SecretManager.Projects.Secrets.TestIamPermissions
...
-- 'SecretManagerProjectsSecretsTestIamPermissions' request conforms to.
type SecretManagerProjectsSecretsTestIamPermissionsResource =
     "v1" Core.:>
...
-- | Returns permissions that a caller has for the specified secret. If the secret does not exist, this call returns an empty set of permissions, not a NOT_FOUND error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may \"fail open\" without warning.
--
-- /See:/ 'newSecretManagerProjectsSecretsTestIamPermissions' smart constructor.
data SecretManagerProjectsSecretsTestIamPermissions = SecretManagerProjectsSecretsTestIamPermissions
    {
      -- | V1 error format.
...
-- | Creates a value of 'SecretManagerProjectsSecretsTestIamPermissions' with the minimum fields required to make a request.
newSecretManagerProjectsSecretsTestIamPermissions 
    :: 
    ...
    -> SecretManagerProjectsSecretsTestIamPermissions
newSecretManagerProjectsSecretsTestIamPermissions payload resource
  = SecretManagerProjectsSecretsTestIamPermissions{xgafv =
                                                     Core.Nothing,
...
instance Core.GoogleRequest
           SecretManagerProjectsSecretsTestIamPermissions
         where
        type Rs SecretManagerProjectsSecretsTestIamPermissions =
             TestIamPermissionsResponse
        type Scopes SecretManagerProjectsSecretsTestIamPermissions =
             '[CloudPlatform'FullControl]
        requestClient SecretManagerProjectsSecretsTestIamPermissions{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecretManagerProjectsSecretsTestIamPermissionsResource)
                      Core.mempty
