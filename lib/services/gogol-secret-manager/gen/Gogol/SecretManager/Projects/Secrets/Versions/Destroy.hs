...
newSecretManagerProjectsSecretsVersionsDestroy name payload
  = SecretManagerProjectsSecretsVersionsDestroy{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SecretManagerProjectsSecretsVersionsDestroy
         where
        type Rs SecretManagerProjectsSecretsVersionsDestroy = SecretVersion
        type Scopes SecretManagerProjectsSecretsVersionsDestroy =
             '[CloudPlatform'FullControl]
        requestClient SecretManagerProjectsSecretsVersionsDestroy{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecretManagerProjectsSecretsVersionsDestroyResource)
                      Core.mempty
