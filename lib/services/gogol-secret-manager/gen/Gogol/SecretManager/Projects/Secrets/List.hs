...
newSecretManagerProjectsSecretsList parent
  = SecretManagerProjectsSecretsList{xgafv = Core.Nothing,
...
instance Core.GoogleRequest SecretManagerProjectsSecretsList where
        type Rs SecretManagerProjectsSecretsList = ListSecretsResponse
        ...
        requestClient SecretManagerProjectsSecretsList{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy :: Core.Proxy SecretManagerProjectsSecretsListResource)
                      Core.mempty
