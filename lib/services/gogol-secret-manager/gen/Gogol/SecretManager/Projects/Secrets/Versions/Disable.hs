...
newSecretManagerProjectsSecretsVersionsDisable name payload
  = SecretManagerProjectsSecretsVersionsDisable{xgafv = Core.Nothing,
...
instance Core.GoogleRequest
           SecretManagerProjectsSecretsVersionsDisable
         where
        type Rs SecretManagerProjectsSecretsVersionsDisable = SecretVersion
        type Scopes SecretManagerProjectsSecretsVersionsDisable =
             '[CloudPlatform'FullControl]
        requestClient SecretManagerProjectsSecretsVersionsDisable{..}
          ...
          where go
                  = Core.buildClient
                      (Core.Proxy ::
                         Core.Proxy SecretManagerProjectsSecretsVersionsDisableResource)
                      Core.mempty
