...
-- |
-- Module      : Gogol.SecretManager.Projects.Locations.Secrets.GetIamPolicy
...
--
-- /See:/ <https://cloud.google.com/secret-manager/ Secret Manager API Reference> for @secretmanager.projects.locations.secrets.getIamPolicy@.
module Gogol.SecretManager.Projects.Locations.Secrets.GetIamPolicy
    (
    -- * Resource
...
-- | A resource alias for @secretmanager.projects.locations.secrets.getIamPolicy@ method which the
-- 'SecretManagerProjectsLocationsSecretsGetIamPolicy' request conforms to.
type SecretManagerProjectsLocationsSecretsGetIamPolicyResource =
     "v1" Core.:>
       Core.CaptureMode "resource" "getIamPolicy" Core.Text Core.:>
         Core.QueryParam "$.xgafv" Xgafv Core.:>
           Core.QueryParam "access_token" Core.Text Core.:>
             Core.QueryParam "callback" Core.Text Core.:>
               Core.QueryParam "options.requestedPolicyVersion" Core.Int32 Core.:>
...
-- | Gets the access control policy for a secret. Returns empty policy if the secret exists and does not have a policy set.
--
-- /See:/ 'newSecretManagerProjectsLocationsSecretsGetIamPolicy' smart constructor.
data SecretManagerProjectsLocationsSecretsGetIamPolicy = SecretManagerProjectsLocationsSecretsGetIamPolicy
    {
      -- | V1 error format.
...
-- | Creates a value of 'SecretManagerProjectsLocationsSecretsGetIamPolicy' with the minimum fields required to make a request.
newSecretManagerProjectsLocationsSecretsGetIamPolicy 
    :: 
                                                     Core.Text
    ...
    -> SecretManagerProjectsLocationsSecretsGetIamPolicy
newSecretManagerProjectsLocationsSecretsGetIamPolicy resource
  = SecretManagerProjectsLocationsSecretsGetIamPolicy{xgafv =
                                                        Core.Nothing,
...
instance Core.GoogleRequest
           SecretManagerProjectsLocationsSecretsGetIamPolicy
         where
        type Rs SecretManagerProjectsLocationsSecretsGetIamPolicy = Policy
        type Scopes SecretManagerProjectsLocationsSecretsGetIamPolicy =
             '[CloudPlatform'FullControl]
        requestClient SecretManagerProjectsLocationsSecretsGetIamPolicy{..}
