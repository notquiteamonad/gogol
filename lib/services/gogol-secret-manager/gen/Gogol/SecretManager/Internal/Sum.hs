...
-- |
-- Module      : Gogol.SecretManager.Internal.Sum
...
module Gogol.SecretManager.Internal.Sum
  (
    ...
    SecretVersion_State
      (
        SecretVersion_State_STATEUNSPECIFIED,
        SecretVersion_State_Enabled,
        SecretVersion_State_Disabled,
        SecretVersion_State_Destroyed,
        ..
      ),
  ) where
...
newtype SecretVersion_State = SecretVersion_State { fromSecretVersion_State :: Core.Text }
    deriving stock (Core.Show, Core.Read, Core.Eq, Core.Ord, Core.Generic)
    deriving newtype
      ( Core.Hashable
      , Core.ToHttpApiData
...
pattern SecretVersion_State_STATEUNSPECIFIED :: SecretVersion_State
pattern SecretVersion_State_STATEUNSPECIFIED = SecretVersion_State "STATE_UNSPECIFIED"

-- | The SecretVersion may be accessed.
pattern SecretVersion_State_Enabled :: SecretVersion_State
pattern SecretVersion_State_Enabled = SecretVersion_State "ENABLED"
...
pattern SecretVersion_State_Disabled :: SecretVersion_State
pattern SecretVersion_State_Disabled = SecretVersion_State "DISABLED"

-- | The SecretVersion is destroyed and the secret data is no longer stored. A version may not leave this state once entered.
pattern SecretVersion_State_Destroyed :: SecretVersion_State
pattern SecretVersion_State_Destroyed = SecretVersion_State "DESTROYED"
